...
const upcomingAiTools = [
  {
    eyebrow: "Soon",
    title: "Resume Analyzer",
    description:
      "Coming soon: compare your resume against each opportunity and spot the gaps before you apply.",
  },
  {
    eyebrow: "Soon",
    title: "Cover Letter Generator",
    description:
      "Coming soon: turn your profile, skills, and opportunity details into focused application drafts.",
  },
];
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight text-[#0F172A] sm:text-4xl">
              Discover, rank, track, and get alerts from one place.
            </h2>
          </div>
