...
function getTelegramDeepLink(code: string, botUsername: string | undefined) {
  if (!botUsername) {
    return null;
  }
...
function getAttemptDeepLink(attempt: TelegramAttempt) {
  return attempt.deepLink ?? getTelegramDeepLink(attempt.code, attempt.botUsername);
}
...
export function TelegramConnectionCard({
  ...
  const attemptDeepLink = attempt ? getAttemptDeepLink(attempt) : null;
            ...
            {attemptDeepLink ? (
              <details className="shrink-0">
                ...
                <div className="mt-3 rounded-md border border-slate-200 bg-white p-3">
                  ...
                  <img
                    src={getQrCodeUrl(attemptDeepLink)}
